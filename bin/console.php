...
try{
 ...
 case 'pulse-sync':echo json((new Ted2\Pulse($store))->sync(in_array('--force',$argv,true)))."\n";break;
 case 'cache-clear':Ted2\Cache62::clear($store);echo "Public rendering cache cleared.\n";break;
