...
final class Store {
 ...
 public function migrate():array{
  $this->init();if($this->db->one("SELECT value FROM v6_meta WHERE key='migration'"))return ['already_upgraded'=>true,'v61'=>Upgrade61::apply($this),'v62'=>Upgrade62::apply($this)];
  ...
  });$report['v61']=Upgrade61::apply($this);$report['v62']=Upgrade62::apply($this);return $report;
 }
}
